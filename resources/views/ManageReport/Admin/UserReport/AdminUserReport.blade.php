...
<body>
        ...
        <div class="tabs">
            <div class="tab">
                ...
                <div class="tab-content">
                    ...
                    <canvas id="userTypeChart" style="max-width: 760px; max-height: 300px; display: none;"></canvas>
            ...
            <div class="tab">
                ...
                <div class="tab-content">
                    ...
                    <canvas id="studentsChart" style="max-width: 760px; max-height: 300px; display: none;"></canvas>
                    <!-- Limit the maximum width and height -->
    ...
    <script>
        ...
        function showGraph(userTypeChart) {
            var chart = document.getElementById(userTypeChart);
            chart.style.display = 'block';
        }
    </script>
